...
public class ReadMoreOption {
    public static final String TAG = ReadMoreOption.class.getSimpleName();
    ...
    public void addReadMoreTo(final TextView textView, final CharSequence text){
        ...
        textView.post(new Runnable() {
            ...
            public void run() {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O && expandAnimation) {
    ...
    public static class Builder {
       ...
       // private int moreLabelColor = R.color.colorPrimary;
        private int moreLabelColor = Color.parseColor("#a6cb45");
       // private int lessLabelColor =  R.color.colorPrimary;
        private int lessLabelColor =  Color.parseColor("#a6cb45");
